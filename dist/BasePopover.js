...
import { Animated, Easing, I18nManager, Platform, StyleSheet, TouchableWithoutFeedback, View } from 'react-native';
...
var BasePopover = /** @class */ (function (_super) {
    ...
    BasePopover.prototype.animateTo = function (args) {
         ...
         */
        var isOpening = fade === 1;
        var translateDuration = Platform.OS === 'android' && isOpening ? 1 : commonConfig.duration;
        Animated.parallel([
            Animated.timing(values.fade, __assign(__assign({}, commonConfig), { toValue: fade })),
            Animated.timing(values.translate, __assign(__assign({}, commonConfig), { toValue: translatePoint, duration: translateDuration })),
    ...
    BasePopover.prototype.render = function () {
        ...
        return (React.createElement(View, { pointerEvents: "box-none", accessibilityViewIsModal: true, importantForAccessibility: "yes", style: [styles.container, { top: -1 * FIX_SHIFT }] },
            ...
            React.createElement(Animated.View, { pointerEvents: "box-none", style: containerStyle, onAccessibilityEscape: this.props.onRequestClose },
                this.props.showBackground !== false && (React.createElement(TouchableWithoutFeedback, { onPress: this.props.onRequestClose, accessible: false, importantForAccessibility: "no-hide-descendants" },
